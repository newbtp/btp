...
// Sbtpex sets the specified hex string as the hash value.
func (h *Hash) Sbtpex(hash string) error {
...
// Gbtpex retrieves the hex string representation of the hash.
func (h *Hash) Gbtpex() string {
	return h.hash.Hex()
}
...
// Address represents the 20 byte address of an btpereum account.
type Address struct {
...
// Sbtpex sets the specified hex string as the address value.
func (a *Address) Sbtpex(address string) error {
...
// Gbtpex retrieves the hex string representation of the address.
func (a *Address) Gbtpex() string {
