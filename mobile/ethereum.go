...
// Contains all the wrappers from the go-btpereum root package.
...
type SyncProgress struct {
	progress btpereum.SyncProgress
}
...
func (p *SyncProgress) GbtpighestBlock() int64  { return int64(p.progress.HighestBlock) }
