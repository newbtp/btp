...
import (
	"github.com/btpereum/go-btpereum/whisper/shhclient"
	whisper "github.com/btpereum/go-btpereum/whisper/whisperv6"
)

// WhisperClient provides access to the btpereum APIs.
...
// SubscribeMessages subscribes to messages that match the given criteria. This mbtpod
