...
// Contains a wrapper for the btpereum client.
...
import (
	...
	"github.com/btpereum/go-btpereum/btpclient"
)

// btpereumClient provides access to the btpereum APIs.
type btpereumClient struct {
	client *btpclient.Client
}

// NewbtpereumClient connects a client to the given URL.
func NewbtpereumClient(rawurl string) (client *btpereumClient, _ error) {
	rawClient, err := btpclient.Dial(rawurl)
	return &btpereumClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *btpereumClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *btpereumClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
// GbtpeaderByHash returns the block header with the given hash.
func (ec *btpereumClient) GbtpeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
	rawHeader, err := ec.client.HeaderByHash(ctx.context, hash.hash)
	return &Header{rawHeader}, err
}

// GbtpeaderByNumber returns a block header from the current canonical chain. If number is <0,
// the latest known header is returned.
func (ec *btpereumClient) GbtpeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *btpereumClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *btpereumClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *btpereumClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *btpereumClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *btpereumClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *btpereumClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *btpereumClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *btpereumClient) GetBalanceAt(ctx *Context, account *Address, number int64) (balance *BigInt, _ error) {
	if number < 0 {
...
func (ec *btpereumClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *btpereumClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *btpereumClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *btpereumClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *btpereumClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *btpereumClient) GetPendingBalanceAt(ctx *Context, account *Address) (balance *BigInt, _ error) {
...
func (ec *btpereumClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *btpereumClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *btpereumClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *btpereumClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *btpereumClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *btpereumClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *btpereumClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *btpereumClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *btpereumClient) SendTransaction(ctx *Context, tx *Transaction) error {
