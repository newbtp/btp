...
func (i *Interface) Sbtpash(hash *Hash)             { i.object = &hash.hash }
func (i *Interface) Sbtpashes(hashes *Hashes)       { i.object = &hashes.hashes }
...
func (i *Interface) Gbtpash() *Hash           { return &Hash{*i.object.(*common.Hash)} }
func (i *Interface) Gbtpashes() *Hashes       { return &Hashes{*i.object.(*[]common.Hash)} }
