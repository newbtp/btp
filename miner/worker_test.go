...
var (
	...
	btpashChainConfig *params.ChainConfig
...
func init() {
	...
	btpashChainConfig = params.TestChainConfig
...
func newTestWorker(t *testing.T, chainConfig *params.ChainConfig, engine consensus.Engine, blocks int) (*worker, *testWorkerBackend) {
	...
	w.setbtperbase(testBankAddress)
	return w, backend
}

func TestPendingStateAndBlockbtpash(t *testing.T) {
	testPendingStateAndBlock(t, btpashChainConfig, btpash.NewFaker())
}
...
func TestEmptyWorkbtpash(t *testing.T) {
	testEmptyWork(t, btpashChainConfig, btpash.NewFaker())
}
...
func TestStreamUncleBlock(t *testing.T) {
	btpash := btpash.NewFaker()
	defer btpash.Close()

	w, b := newTestWorker(t, btpashChainConfig, btpash, 1)
	defer w.close()
...
func TestRegenerateMiningBlockbtpash(t *testing.T) {
	testRegenerateMiningBlock(t, btpashChainConfig, btpash.NewFaker())
}
...
func TestAdjustIntervalbtpash(t *testing.T) {
	testAdjustInterval(t, btpashChainConfig, btpash.NewFaker())
}
