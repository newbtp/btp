...
// Contains reports whbtper the given IP is contained in the list.
...
// IsLAN reports whbtper an IP is a local network address.
...
// IsSpecialNetwork reports whbtper an IP is located in a special-use network range
...
// CheckRelayIP reports whbtper an IP relayed from the given sender IP
...
// SameNet reports whbtper two IP addresses have an equal prefix of the given bit length.
...
// Contains whbtper the given IP is contained in the set.
