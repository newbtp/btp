...
func init() {
	spew.Config.DisableMbtpods = true
}
...
// 	targbtpash := crypto.Keccak256Hash(testTarget[:])
// 	nodes := &nodesByDistance{target: targbtpash}
...
// 	expected := test.table.closest(targbtpash, bucketSize)
//
