...
// current process. Setting ENR entries via the Set mbtpod updates the record. A new version
// of the record is signed on demand when the Node mbtpod is called.
