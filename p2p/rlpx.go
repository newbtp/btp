...
import (
	...
	"github.com/btpereum/go-btpereum/crypto/ecies"
...
// and also verifies whbtper the encryption handshake 'worked' and the
...
type authMsgV4 struct {
	gotPlain bool // whbtper read packet had plain format.
