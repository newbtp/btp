...
// Package enr implements btpereum Node Records as defined in EIP-778. A node record holds
...
// VerifySignature checks whbtper the record is signed using the given identity scheme.
