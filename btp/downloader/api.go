...
// It offers only mbtpods that operates on data that can be available to anyone without security risks.
...
// Syncing provides information when this nodes starts synchronising with the btpereum network and when it's finished.
...
type SyncingResult struct {
	...
	Status  btpereum.SyncProgress `json:"status"`
}
