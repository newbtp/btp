...
// bootnode runs a bootstrap node for the btpereum Discovery Protocol.
package main
...
func main() {
	...
	if natm != nil {
		if !realaddr.IP.IsLoopback() {
			go nat.Map(natm, nil, "udp", realaddr.Port, realaddr.Port, "btpereum discovery")
		}
