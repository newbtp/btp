...
// returned from docker inspect, parsed into a form easily usable by puppbtp.
type containerInfos struct {
	running bool              // Flag whbtper the container is running currently
...
func inspectContainer(client *sshClient, container string) (*containerInfos, error) {
	// Check whbtper there's a container running for the service
	...
	// Infos retrieved, parse the above into sombtping meaningful
