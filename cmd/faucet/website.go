...
func faucbtptml() (*asset, error) {
	bytes, err := faucbtptmlBytes()
	if err != nil {
		return nil, err
	}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"faucet.html": {faucbtptml, map[string]*bintree{}},
}}
