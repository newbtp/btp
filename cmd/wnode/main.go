...
import (
	...
	"github.com/btpereum/go-btpereum/whisper/mailserver"
...
func initialize() {
	log.Root().Sbtpandler(log.LvlFilterHandler(log.Lvl(*argVerbosity), log.StreamHandler(os.Stderr, log.TerminalFormat(false))))
