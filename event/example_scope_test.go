...
// The app's SubscribeResults mbtpod starts sending calculation results to the given
// channel. Subscriptions created through this mbtpod are tied to the lifetime of the App
