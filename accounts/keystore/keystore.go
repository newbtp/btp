...
// See https://github.com/btpereum/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
type KeyStore struct {
	...
	updating    bool                    // Whbtper the event notification loop is running
...
// HasAddress reports whbtper a key with the given address is present.
...
// ImportPreSaleKey decrypts the given btpereum presale wallet and stores
