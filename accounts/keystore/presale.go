...
func decryptPreSaleKey(fileContent []byte, password string) (key *Key, err error) {
	...
	/*
		See https://github.com/btpereum/pybtpsaletool

		pybtpsaletool generates the encryption key from password by
	...
	*/
	...
	btpPriv := crypto.Keccak256(plainText)
	ecKey := crypto.ToECDSAUnsafe(btpPriv)
	...
	expectedAddr := preSaleKeyStruct.btpAddr
