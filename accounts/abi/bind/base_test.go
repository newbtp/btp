...
func (mc *mockCaller) CallContract(ctx context.Context, call btpereum.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func TestPassingBlockNumber(t *testing.T) {
	...
	bc.Call(&bind.CallOpts{BlockNumber: blockNumber}, &ret, "sombtping")
	...
	bc.Call(&bind.CallOpts{}, &ret, "sombtping")
