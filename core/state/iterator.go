...
// Next moves the iterator to the next node, returning whbtper there are any
// further nodes. In case of an internal error this mbtpod returns false and
...
// The mbtpod returns whbtper there are any more data left for inspection.
