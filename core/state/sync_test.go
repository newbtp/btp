...
// account array.
func checkStateAccounts(t *testing.T, db btpdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db btpdb.Database, root common.Hash) error {
...
func checkStateConsistency(db btpdb.Database, root common.Hash) error {
...
func TestIncompleteStateSync(t *testing.T) {
	...
	checkTrieConsistency(srcDb.TrieDB().DiskDB().(btpdb.Database), srcRoot)
