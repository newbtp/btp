...
type journalEntry interface {
	...
	// dirtied returns the btpereum address modified by this journal entry.
...
// otherwise suggest it as clean. This mbtpod is an ugly hack to handle the RIPEMD
...
type (
	...
	suicideChange struct {
		account     *common.Address
		prev        bool // whbtper account had already suicided
		prevbalance *big.Int
	}
