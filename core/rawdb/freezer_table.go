...
// preopen opens all files that the freezer will need. This mbtpod should be called from an init-context,
...
func (t *freezerTable) truncate(items uint64) error {
	...
	// Sombtping's out of sync, truncate the table's offset index
...
//
// Note, this mbtpod will *not* flush any data to disk so be sure to explicitly
...
// has returns an indicator whbtper the specified number data
