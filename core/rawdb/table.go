...
func NewTable(db btpdb.Database, prefix string) btpdb.Database {
	return &table{
		db:     db,
		prefix: prefix,
	}
...
func (t *table) NewIterator() btpdb.Iterator {
...
// not exist).
func (t *table) NewIteratorWithStart(start []byte) btpdb.Iterator {
	return t.db.NewIteratorWithStart(start)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (t *table) NewIteratorWithPrefix(prefix []byte) btpdb.Iterator {
...
func (t *table) NewBatch() btpdb.Batch {
...
func (b *tableBatch) Replay(w btpdb.KeyValueWriter) error {
