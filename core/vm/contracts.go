...
import (
	...
	"github.com/btpereum/go-btpereum/crypto/bn256"
	"github.com/btpereum/go-btpereum/params"
	"golang.org/x/crypto/ripemd160"
)

// PrecompiledContract is the basic interface for native Go contracts. The implementation
// requires a deterministic gas count based on the input size of the Run mbtpod of the
// contract.
...
// PrecompiledContractsHomestead contains the default set of pre-compiled btpereum
...
// PrecompiledContractsByzantium contains the default set of pre-compiled btpereum
...
//
// This mbtpod does not require any overflow checking as the input size gas costs
