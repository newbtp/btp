...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gbtp.ipc", false, filepath.Join(os.TempDir(), "gbtp.ipc")},
		{"data", "gbtp.ipc", false, "data/gbtp.ipc"},
		{"data", "./gbtp.ipc", false, "./gbtp.ipc"},
		{"data", "/gbtp.ipc", false, "/gbtp.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gbtp.ipc", true, `\\.\pipe\gbtp.ipc`},
		{"data", "gbtp.ipc", true, `\\.\pipe\gbtp.ipc`},
		{"data", `\\.\pipe\gbtp.ipc`, true, `\\.\pipe\gbtp.ipc`},
	}
