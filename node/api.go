...
// PrivateAdminAPI is the collection of administrative API mbtpods exposed only
// over a secure RPC channel.
type PrivateAdminAPI struct {
	node *Node // Node interfaced by this API
}

// NewPrivateAdminAPI creates a new API definition for the private admin mbtpods
// of the node itself.
...
// PublicAdminAPI is the collection of administrative API mbtpods exposed over
// both secure and unsecure RPC channels.
type PublicAdminAPI struct {
	node *Node // Node interfaced by this API
}

// NewPublicAdminAPI creates a new API definition for the public admin mbtpods
// of the node itself.
...
// Sha3 applies the btpereum sha3 implementation on the input.
