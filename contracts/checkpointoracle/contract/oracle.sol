 ...
 * @author Gary Rong<garyrong@btpereum.org>, Martin Swende <martin.swende@btpereum.org>
...
contract CheckpointOracle {
    ...
    */
    ...
    //
    // The default value should be the same as the checkpoint size(32768) in the btpereum.
    uint sectionSize;
