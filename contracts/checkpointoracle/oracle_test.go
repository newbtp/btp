...
import (
	...
	"github.com/btpereum/go-btpereum/accounts/abi/bind/backends"
...
// assertSignature verifies whbtper the recovered signers are equal with expected.
...
func TestCheckpointRegister(t *testing.T) {
	...
	// assert checks whbtper the current contract status is same with
	// the expected.
