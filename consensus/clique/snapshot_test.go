...
// mapped from textual names used in the tests below to actual btpereum private
...
// address retrieves the btpereum address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the btpereum address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/btpereum/go-btpereum/issues/17593). Whilst this
	...
	for i, tt := range tests {
		...
		for j, block := range blocks {
			// Gbtp the header and prepare it for signing
			header := block.Header()
			if j > 0 {
